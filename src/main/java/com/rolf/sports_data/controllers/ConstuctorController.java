...
public class ConstuctorController {
    ...
    public ConstuctorController(ConstructorService constructorService) {
        this.constructorService = constructorService;
    }

    @GetMapping("/constructors")
    public List<ConstructorResponseDto> fetchContructors() {
        return constructorService.fetchAllContructors();
    }
